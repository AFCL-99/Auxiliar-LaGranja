PROVIDERS = {
    "ITALCOL DE OCCIDENTE SA": {
        "warehouse": 69,
        "supplier": {
            "id": "c7eb727c-5080-4f73-ab0a-da428ffe3154",
            "identification": "891304762",
            "branch_office": 0,
        },
    ...
    "SIERRA PINEDA": {
        "warehouse": 69,
        "supplier": {
            "id": "a3ae24b1-0d52-4294-a93c-fa5945cc16a2",
            "identification": "890705018",
            "branch_office": 0,
        },
        "discount": {"type": "Percentage", "value": 2},
        "retefuente": {"enabled": False},
    ...
    "ITALCOL": {
        "warehouse": 69,
        "supplier": {
            "id": "a509c230-ea98-4f22-b384-ff2a37bbb094",
            "identification": "860026895",
            "branch_office": 0,
        },
        "discount": {"type": "Value", "value": 0},
        "retefuente": {"enabled": False},
    ...
    "GABRICA": {
        "warehouse": 69,
        "supplier": {
            "id": "ede62362-8831-4ccb-ae91-679875815034",
            "identification": "800164767",
            "branch_office": 0,
        },
        "discount": {"type": "Value", "value": 0},
        "retefuente": {"enabled": False},
